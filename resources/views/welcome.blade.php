        ...
        <div class="col-sm-6">
                <div id="carouselExampleIndicators" class="carousel slide mt-5 pt-5" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <img class="d-block w-100" src="{{ url('images/user-cover.png') }}" alt="">
              ...
              <form role="form">
                <div >
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="message" id="" cols="30" id="meessage" rows="3" class="form-control"></textarea>
                  </div>
